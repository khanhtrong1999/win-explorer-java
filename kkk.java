...
public class kkk extends JFrame {
	...
	public kkk() {
		...
		btnUndo.setIcon(new ImageIcon(kkk.class.getResource("/com/sun/javafx/scene/web/skin/Undo_16x16_JFX.png")));
		panel_3.add(btnUndo);
		
		JButton btnRedo = new JButton("");
		btnRedo.setIcon(new ImageIcon(kkk.class.getResource("/com/sun/javafx/scene/web/skin/Redo_16x16_JFX.png")));
		panel_3.add(btnRedo);
